                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        <a href="/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add" class="add-to-cart-link" style="font-size: 10px", ><i class="fa fa-shopping-cart"></i> Comprar</a>
                                        <a href="/products/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="view-details-link" style="font-size: 10px"><i class="fa fa-link"></i> Ver Detalhes</a>
                                    </div>
                                </div>
